// ================ Данные казино ================
const CASINOS = [
    {name:"Вавада", desc:"Легендарное место, где легенды тоже проигрывают.", promo:"VAVADA777", categories:["Топ","Шутка"], img:"https://placehold.co/600x300/333/d4af37?text=Vavada", url:"#"},
    {name:"Стейк", desc:"Сочный сайт, прожаренный на 100% неудачи.", promo:"MEAT100", categories:["Топ"], img:"https://placehold.co/600x300/333/d4af37?text=Stake", url:"#"},
    {name:"Водка", desc:"Пей, играй, проигрывай — в правильном порядке!", promo:"SHOT2025", categories:["Шутка"], img:"https://placehold.co/600x300/333/d4af37?text=Vodka", url:"#"},
    {name:"Буй", desc:"Корабль фортуны, который уже утонул. Но весело!", promo:"BOOM1", categories:["Топ"], img:"https://placehold.co/600x300/333/d4af37?text=Boooi", url:"#"},
    {name:"ПлейФортуна", desc:"Фортуна играет, но не с тобой.", promo:"FORT999", categories:["Новые"], img:"https://placehold.co/600x300/333/d4af37?text=PlayFortuna", url:"#"},
    {name:"ДжойКазино", desc:"Радость заканчивается, когда заходишь на сайт.", promo:"JOY0", categories:["Топ"], img:"https://placehold.co/600x300/333/d4af37?text=JoyCasino", url:"#"},
    {name:"СКАМ", desc:"Никакого скама! Только проверенные мемы!", promo:"", categories:["Фейк"], img:"https://placehold.co/600x300/333/ff6961?text=SCAM", url:"#", fake:true}
];
